...
\begin{frame}{Vote-Buying Literature Builds on the Wrong Framework}
...
\subsection{Motivate the problem}
...
\subsection{The Problem: Theory}

\begin{frame}{Clientelism and the Expected Utility Theory}
  \begin{itemize}
...
\subsection{The Problem: Empirical}

\begin{frame}{Clientelism and the Expected Utility Theory}
  \begin{itemize}
    \item These assumptions have led to several empirical inconsistencies.
    \item Authors tend to ignore or treat them as unimportant empirical deviations:
        \begin{enumerate}
...
\begin{frame}{Clientelist Targeting}
  \begin{itemize}
...
\begin{frame}{Political Contestation}
  \begin{itemize}
    \item Test
  \end{itemize}
\end{frame}
...
\begin{frame}{Several Empirical Findings Don't Conform with the EUT}
    \begin{itemize}
      \item Safe to say that 99\% of the vote-buying literature takes the Expected Utility Theory as a starting point:
          \begin{itemize}
            \item Approach focused 
          \end{itemize}
    \end{itemize}
\end{frame}
