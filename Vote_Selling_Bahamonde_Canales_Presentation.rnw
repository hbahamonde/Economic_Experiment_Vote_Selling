...
\includegraphics[scale=0.45, center]{depvarplot.png}
...
\begin{frame}[c]
        ...
        \begin{itemize}
            \vspace{-1.5cm}\item[1.] Parties buy vote more when winning the election (not when losing).
        \end{itemize}
\end{frame}
...
\includegraphics[scale=0.4, center]{m1plot_1.png}
