    ...
    \item {\bf If we follow what the literature says...the answers are mixed}:\pause
     ...
     \item {\bf And yet...}:
        \begin{enumerate}
            ...
            \item[?] The role of past losses has been completely overlooked (``sunk cost {\bf \emph{fallacy}}'').
        \end{enumerate}
   \end{itemize}
\end{frame}
...
\begin{frame}{Not Clear Who Clientelist Parties Target}
  \begin{itemize}
    ...
    \item Since allocating resources to individuals who are already voting for the party is a waste, parties should target {\bf swing voters}.\\
    ...
    \item {\color{blue}Thus, the literature unfortunately does not provide a clear answer to this question}.\\
  ...
  %\begin{%}
    ...
    \item PT: parties focus on {\bf loses} {\color{blue}(hold on to what they ``own'')}.
      \begin{enumerate}
        ...
        \item Buy more votes when {\bf sunk costs} are high. %(need to spend  more to ``\emph{break even}'') 
      \end{enumerate}
  \end{itemize}
%\end{itemize}
\end{column}
...
\begin{frame}%{Payoffs}
  ...
  \begin{column}{.48\textwidth}
      \begin{itemize}
        \item Due to {\bf loss aversion}, parties buy more votes when they're likely winners (not losers).
...
\begin{frame}%{Payoffs}
  ...
  \begin{column}{.48\textwidth}
      \begin{itemize}
        \item Unlike EUT, parties do consider sunk costs, buying more votes to compensate for past losses.
...
\begin{frame}%{Payoffs}
  ...
  \begin{column}{.48\textwidth}
      \begin{itemize}
        \item Parties buy votes---at higher, not lower prices---from core voters.
...
\begin{frame}%{Payoffs}
  ...
  \begin{column}{.48\textwidth}
      \begin{itemize}
        \item Parties with larger budgets spend more on vote buying.
      \end{itemize}
\end{column}
\hfill%
  \begin{column}{.48\textwidth}
...
\begin{frame}%{Payoffs}
    ...
    \item This paper identified {\bf three main gaps} in the literature:
      \begin{enumerate}
        \item {\color{blue}clientelist targeting}.
        \item {\color{blue}electoral contestation}.
        \item {\color{blue}sunk costs}.\pause
      \end{enumerate}
