...
% random
                    ...
                    % 2
                    \node[draw,align=center,fill=orange,text=black] (OFFERP) at (-6,-5.5) {Voters consider\\selling voters}; % 1
                    \path [red,  ->] (1,-5.5) edge (4,-5.5);

                    % 3
                    \node[draw,align=center,fill=green,text=black] (OFFERV) at (11,-5.5) {Parties consider\\offerings, if any}; % 1
