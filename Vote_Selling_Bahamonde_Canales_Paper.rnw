...
% plots:m1
<<plots:m1, echo = FALSE, fig.pos='H', warning = FALSE, message = F, fig.cap=m1.all.plots.note, fig.align='center', fig.width=12, fig.height=5,dpi=10000,cache=FALSE, include = TRUE>>=
