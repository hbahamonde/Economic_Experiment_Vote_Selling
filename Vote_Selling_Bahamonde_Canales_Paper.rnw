...
\newpage
\section{Vote Buying as a Risky Gamble}

% Risk is a central feature of political decision making
``Risk is a central feature of political decision making'' \parencite[334]{Vis2011}. For instance, governments might need to pursue unpopular reforms \parencite{Vis2007,Vis2009,Weyland2002} likely risking political support. Another example is when political parties might fear losing elections, and as a consequence, might feel the need to resort to alternative methods other than delivering policy packages in order to secure electoral victories \parencite{Kitschelt2000}. One of these alternatives is vote buying, which is defined a the distribution of rewards during elections in contingent exchange for vote choices \parencite[316]{Nichter2014}.

% Vote buying is a risky strategy, why
Vote buying is a very risky strategy. First, it is illegal (see \textcite{Bahamonde2020a} for a historical review on the United States). Political parties engaging in vote buying might risk losing electoral support from the wealthy \parencite{Weitz-shapiro} or from society in general \parencite{GonzalezOcantos2014}, thus endangering positive electoral outcomes. Second, vote choices are secret; voters may accept the private benefit from the clientelist party but then defect and vote for another party \parencite{Stokes2005,Nichter2008,GonzalezOcantos2014,Vicente2014}. 


% Yet, despite these risks, vote buying is very comon.
Yet, despite these risks, political parties buy votes in many parts of the world \parencite[F356]{Vicente2014}. The literature has described a few choices parties have to cope with these risks when buying votes. However, all of them give incomplete information at best. \textcite[1147]{Dixit1996} explain that parties track ``constituents' likes and dislikes, \emph{compulsively} participating in a spectrum of events [such as] baptisms and bar mitzvahs.''\footnote{Emphases are mine.} \textcite[317]{Stokes2005} argues that parties develop skills that allow them to infer whether clients voted for their party by \emph{looking at them in the eyes.} \textcite{Gay:1993aa,Gay1998} documents similar findings for Brazilian case. Overall, vote buying requires parties to sustain close relationships over time with their clients in a personal and individualized way \parencite{Auyero2000,Szwarcberg2013,Bahamonde2018}. Unfortunately, parties are left with no more than guesses about whether their clientelistic investments were effective or not. 
...
``the analysis demonstrates that a party may simultaneously target both swing and core groups of voters with particularistic goods, the choice being determined by the distributive good.'' Albertus2012a
