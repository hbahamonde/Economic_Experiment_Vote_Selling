...
% plots:m1
<<plots:m1:ok, echo = FALSE, fig.pos='h', warning = FALSE, message = F, fig.cap=m1.all.plots.note, fig.align='center', fig.width=4, fig.height=2,dpi=100,cache=FALSE, include = TRUE>>=
