...
% plots:m1
<<plots:m1:ok, echo = FALSE, fig.pos='h', warning = TRUE, message = F, fig.cap=m1.all.plots.note, fig.align='center', fig.width=10, fig.height=5,dpi=100,cache=FALSE, include = TRUE>>=
