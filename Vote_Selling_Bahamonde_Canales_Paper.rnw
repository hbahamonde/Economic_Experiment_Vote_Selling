...
\textcite{Neumann:1947tc} introduced one of the first theories of decision making under risk \parencite[15]{McDermott1998}. Since then, a specific set of behavioral assumptions have dominated political science (\cite[289]{McDermott2004}, \cite[87]{Levy1997}), and traditional accounts of vote buying have been no exception. Just to name a few examples, \textcite{Nichter2008} used game-theoretical techniques to introduce the concept of ``turnout buying,'' suggesting that parties deliver private benefits even when monitoring is absent. \textcite{Gans-Morse2013} offer a formal model to explain that clientelist parties utilize a mix of four clientelist strategies during elections (vote buying, turnout buying, abstention buying, and double persuasion), while \textcite[428]{Rueda2014a} presents a game-theoretical model of vote buying in which a broker sustains bribed voters' compliance by conditioning future bribes. Similarly, \textcite[401]{Gallego2014} develops a formal model of political clientelism in which a candidate disciplines a majority of voters through the promise of a future flow of benefit.

% Formal models in clientelism: example and clarification
We contest this traditional approach focused on absolute gains by shifting the attention to losses and context-dependent decision-making processes. It needs to be clarified, however, that the root of the problem is \emph{not} methodological (i.e., the use of game theory) but analytical. In particular, we contest the assumed decision-making process under risk embedded in most traditional accounts of vote buying. We find it limiting that most research focuses on absolute levels of wealth, while assuming that whether decision-makers are in a domain of gains or losses should not affect their attitudes toward risk. We believe that a shift in focus is a valuable exercise because strategic behavior under risk has usually been modeled according to assumptions about expected-value calculations that are  ``unrealistic'' \parencite[124]{Aldrich2011}. Since these assumptions have also been integrated in most traditional vote-buying theories, our paper hopefully clarifies some empirical deviations present in the literature. 
...
Incumbents are usually portrayed as if they were always in the domain of gains, as the ``incumbency \emph{advantage}'' concept implies. However, we tend to disagree with this view. First, the material, coordination, and political costs of maintaining a large-scale vote-buying operation is very high \parencite{Scott1969,Auyero2000,Szwarcberg2013}. Party machines need to have the capacity to grant public jobs to their clients \parencite{Calvo2004}, but also to organize rallies \parencite{Szwarcberg2012}, deliver benefits \parencite{Brusco2004}, and ``\emph{acarrear},'' \parencite[577]{Hilgers2011} and monitor clients at the best of the machine's abilities \parencite[317]{Stokes2005}. Second, incumbents face a number of uncertainties. Party machines cannot effectively monitor their clients \parencite{Hicken2011} and struggle obtaining resources to be delivered in a clientelist manner \parencite{Auyero2000,Zarazaga2014}. If vote buying is expensive and uncertain, \emph{what motivates clientelist political parties to buy such massive numbers of votes, as the Nicaraguan example above suggested?} In this context of uncertainty and risk, we argue that clientelist political parties will ``gamble'' more money and resources to compensate for prior losses. For every additional unit incumbents spend on vote buying, they will feel the need to spend even more to ``break even'' to try to compensate for prior losses or clientelist investments.
