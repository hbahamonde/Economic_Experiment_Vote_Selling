...
Clientelist parties will likely buy more votes when they are winning the election, that is, when they are in the domain of gains. In these scenarios parties will find unbearable the idea of losing the political base they already have. Analytically, under such circumstances, parties will give more weight to potential losses, and the value function will encourage risk-averse behaviors making investments in vote buying more attractive. It should be noted that the aversion is respect to negative prospective electoral outcomes, e.g. losing an important portion of the political base already acquired. In terms of the argument, we posit that loss aversion explains why decision-makers are more concerned with preventing a decline than increasing gains (\cite[285]{Levy1992}, see also \cite[89]{Levy1997}). This is consistent with prospect theory, particularly, with the concept of the ``endowment effect:'' the very process of acquiring something (e.g. an important political base) enhances the value of the object, making decision-makers to over-value current possessions (\cite{Thaler1980}, \cite[175]{Levy1992a}). Thus, agents will find intolerable the idea of losing acquired assets, even ``trivial [ones, such] as candy bars or coffee mugs'' \parencite[175]{Levy1992a}, enhancing the false perception that agents might be in the domain of losses. In fact, empirical studies confirm that ``actors perceive themselves to be in the domain of losses more often than we would normally expect,'' even if they are not (\cite[291]{Levy1992}; see also \cite{Lau1985}). To sum, when things are going well electorally, clientelist political parties will tend to buy more votes because ``future losses hurt more than future gains gratify'' \parencite[285]{Levy1992}. Thus, we expect vote buying to be an attractive strategy in favorable electoral scenarios due to the absolute aversion and intolerance of losing an already acquired important political base. %The mechanics of such a decision-making process should then make clear that there is no ``wasting'' when when buying votes while in the domain of gains.
