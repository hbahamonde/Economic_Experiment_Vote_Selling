...
\newpage
\section{Vote Buying: A Risky Yet Persistent Gamble}
...
Vote buying is a very risky strategy.\footnote{Vote buying is defined as the distribution of rewards during elections in contingent exchange for vote choices \parencite[316]{Nichter2014}.} First, it is illegal. \textcite{Bahamonde2020a} explains that in the United States vote buying was illegal as early as the 1700s. Thus, buying votes requires extra care so to avoid reputational costs and legal issues. For instance, due to stigma associated with vote buying, clientelist political parties might risk losing electoral support from the wealthy \parencite{Weitz-shapiro} or from society in general \parencite{GonzalezOcantos2014}. Second, vote choices are secret, thus preventing parties from effective monitoring and enforcing \parencite{Nichter2008}. Even in developing contexts such as Africa \parencite{Wantchekon2003,Vicente2014} and Latin America \parencite{Hidalgo2012,Oliveros2019,Murillo2021a}, voters might accept the private benefit but then secretly vote for another party \parencite{Stokes2005,Nichter2008,Szwarcberg2013,GonzalezOcantos2014,Vicente2014}. In fact, since clientelism may also work with low levels of enforcement, monitoring and credible commitments \parencite{Hicken2020}, investments in clientelism are always done under contexts of very high risk.

% Yet, despite these risks, vote buying is very common.
Yet, despite all these risks, political parties still buy votes in many parts of the world \parencite[F356]{Vicente2014}. For instance, in some countries vote buying is so deeply embedded in electoral politics that \textcite{Gonzalez-Ocantos2012} report that 24\% of registered voters in Nicaragua were offered a clientelist gift. 

% Why do parties keep buying votes?
If clientelism is risky \parencite[43]{Szwarcberg2013}, expensive \parencite[35]{Zarazaga2014} and uncertain \parencite{Rueda2016}, \emph{Why do political parties buy votes?} The core of the answer rests on the idea that clientelist political anticipating electoral losses resort to vote buying \parencite{Diaz-Cayeros2008}. More importantly, given that resources aimed at buying votes are limited, \emph{Who do political parties target? Do political parties buy votes because they want to reassure electoral loyalties (core voters) or because they want to flip voters (swing voters)?} 

% Literature provides conflicting answers, with some recent helpful views
While all these are important questions as they speak about the party's decision-making process in risky contexts, unfortunately, the literature provided conflicting answers. In fact, \textcite[14]{Carlin2015} states that ``our knowledge of who parties target remains incomplete.'' On the one hand, \textcite{Cox1986} and \textcite[7]{Zarazaga2015a} explain that since constituencies are well known to clientelist parties, they allocate resources to core voters. On the other hand, \textcite{Lindbeck1987,Dixit1996,Stokes2005} argue that since allocating resources to individuals who \emph{ex-ante} vote for the party is a waste, parties target swing voters. In order to contribute to solving this debate, \textcite[1083]{Albertus2012a} explains that clientelist parties ``may simultaneously target both swing and core groups of voters,'' while in a similar vein \textcite[148]{Diaz-Cayeros2008} explains that long-lasting hegemonic parties (such as the PRI in Mexico) seek ``to prevent core voters from defecting in the future,'' but newly elected incumbents in need of forging a new majority coalition targeted swing voters. 

% 
This paper argues that these conflicting views are product of the theoretical framework leveraged as a starting point. In particular, most most quantitative researchers have framed their answers within the game-theoretical oriented expected utility theory (EUT) \parencite{Neumann:1947tc}.\footnote{For the purposes of this paper, I focus exclusively on quantitative research. Among others, very important qualitative papers are \textcite{Scott1972}, \textcite{Auyero2000} and \textcite{Szwarcberg2013}.} 

While there are multiple answers to this question, unfortunately, 



For instance, 

I consider this an important limitation. \todo{here why EUT has failed}
...
``spending diversification is a rational response by incumbent
parties to their chances of losing an election'' Diaz-Cayeros2008, 130

``Parties seek to use public funds primarily to reward their own supporters. But when loyal core constituencies are not large enough to guarantee electoral victory, discretionary expenditure is allocated to risky voters.'' Diaz-Cayeros2008, 130
...
\textcite{Nichter2008} used game-theoretical techniques to introduce the concept of ``turnout buying,'' suggesting that parties deliver private benefits even when monitoring is absent.

\textcite{Gans-Morse2013} offer a formal model to explain that clientelist parties  offer a mix four clientelist strategies during elections (vote buying, turnout buying, abstention buying, and double persuasion)


Since this framework ``was one of the first theories of decision making under risk'' \parencite[15]{McDermott1998}, EUT has dominated political science for the most part \parencite[289]{McDermott2004}, and the vote buying literature has been no exception. As its core, EUT considers that the value of an outcome is equal to its payoff times its probability, and that individuals choose the option with the highest weighted sum  (\cite[15]{McDermott1998}, \cite[173]{Levy1992a})
...
% ``it is commonly assumed that most if not all economic and political agents obey the maxims of consistency and coherence leading to the maximization of utility.'' Quattrone1988, 719


%% It doesn't work

    % ``Many formal models contain descriptions of political perceptions, opinions, and behaviors that are unrealistic.'' Aldrich2011


% ``Pure rational choice based theories contend that voters choose to achieve an electoral outcome closer to their preferences-that is, they have instrumental or investment motivations.'' Bassi2011, 558
...
% ``Bernoulli was the ‹rst to see this contradiction [showing] that people would not always bet solely on the basis of the expected value of a game.'' McDermott1998, 15-16
...
Gonzalez-Ocantos2015 ``legitimacy buying''
Gallego2014 ``Self-Enforcing Clientelism''

Vote-buying is an expensive strategy \textcite[35]{Zarazaga2014}

``We argue that this relationship is driven by the fact that politicians outsource some of their vote-buying efforts to interest associations'' Holland2015
...
% ``Both variance and semivariance ideas of risk, however, have been shown to be inconsistent with von Neumann axioms.'' March1987, 1405

% ``It is not certain, however, that managers believe that risk and retum are positively correlated.'' March1987, 1405

% ``the assumptions underlying the classical theory of risky choice are systematically violated in the manner predicted by prospect theory.'' Quattrone1988, 719

% ``people systematically violate the predictions of expected utility theory, economists' workhorse model of decision making under risk.'' Barberis2013, 173

% ``expected utility theory since the latter theory’s predictions continually failed empirically'' Vis2011, 335

% ``A decade of laboratory experiments revealed that people systematically violate the axioms of subjective expected utility theory.'' Mercer2005, 1
...
% ``Experiments and empirical observations have revealed that actual behavior and decisions frequently deviate from the neoclassical predictions.'' Fatas2007, 167
...
% ``Experiments have identified a number of well-known violations of expected utility theory'' Battalio1990, 25
