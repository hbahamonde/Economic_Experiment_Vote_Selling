...
Importantly, it should be noted that the aversion is respect to potential negative electoral outcomes (i.e., losing an already acquired supporter base). This is consistent with prospect theory, particularly, with the concept of ``endowment effect:'' the very process of acquiring something (e.g. a supporter base) enhances the value of the object \parencite{Thaler1980a,Kahneman1990a}. In these situations, decision-makers (parties) tend to over-value current possessions \parencite[175]{Levy1992a}, making the risky strategy (vote buying) seem more attractive. In fact, \textcite{Horowitz2002} find that losing something looms 2.5 times more than obtaining it, thus making agents more eager to hold on to the good. Our argument is also consistent with \textcite[1042]{Schumacher2015}, where they also find that ``loss aversion motivates [agents] to become risk acceptant.'' Then, in the context of vote buying we argue that the idea of losing something (voters) shifts the decision-maker's reference point (party), driving them to take the risky alternative (vote buying). 

Hence, we expect vote buying to be higher in contexts where parties are winning the election. Decision makers in those situations will find intolerable the idea of losing acquired assets---this also applies even to ``trivial [ones, such] as candy bars or coffee mugs'' \parencite[175]{Levy1992a}. Note that this goes in line with other empirical studies that also confirm that ``actors perceive themselves to be in the domain of losses more often than we would normally expect,'' even if they are not (\cite[291]{Levy1992}; see also \cite{Lau1985}). Thus, both loss aversion and the endowment effect will imply that winning parties will perceive themselves in the domain of losses more often, making them more prone to gamble more on vote buying.
...
Importantly, the risk-seeking behavior is with respect to vote buying as a strategy. By shifting the decision-makers' reference point downward, vote buying seems more attractive because of the tendency of individuals in the domain of losses to try to ``break-even''  \parencite{Thaler1990}. This implies that clientelist political parties should be expected to buy more votes, not necessarily because they want to win the next election but because they will try to compensate for past losses or ``sunk costs.''\footnote{Due to the ``cost of governing'' \parencite{Powell1993,Nannestad2002,Bawn2012}, \textcite[1041]{Schumacher2015} empirically find that incumbents in the domain of losses take more risks. In terms of our argument, we also find it might be plausible that incumbents fear losing office, thus incentivizing more investments in clientelism. However, while our explanation complements theirs, our formal model, the experimental design and the data analyses focus on the relationship between incumbency and sunk costs (i.e., the need to break even with past investments). Building on \textcite{Schumacher2015}, we encourage future experimental research to problematize the incumbent's risk of losing office. I thank one of the reviewers for this suggestion.} We theorize that clientelist parties will buy more votes when their past electoral losses or past levels of clientelist investments have been high. Clientelist parties that have a history of lost elections or that have invested considerable amounts in vote buying in the past are possible examples of this mechanism. 
...
% ideology
Voters were assigned an ``ideological'' position at random. That is, voters received at random a certain number of experimental points depending on whether party A or B won the election. For example, if party A won the election, the voter would receive 2,400 points, whereas if party B won the election, the voter would receive 200 points. Hence, the voter in this example should feel ``ideologically'' closer to party A. The idea was to model party-voter spatial distances, as considered by traditional voting theories \parencite{Downs:1957vg, Enelow:1990aa}. The basic premise of this paradigm is that the set of candidates that are ideologically closer to a voter produce more utility in the form of fiscal policies, either in terms of redistributive or free-market oriented policies (\cite{Acemoglu:1996rm,Boix:2003db}, but importantly, see \cite{Haggard:2016vr}). Critically, this piece of information was not presented to participants as ``ideology,'' but as the points either electoral outcome would give. In turn, parties also received an ``ideological'' position that made them ``closer'' or ``farther way'' from the voter.  

% HERE

% endowments
Parties received different ``endowments'' at random as well. The idea was to reflect the fact that some parties are wealthier than others, a factor that might increase the probability of vote buying  \parencite{Juan-Pablo-Luna:2014wp}. Note that both parties receive the same endowment. Since our experimental design is an in-between-subjects design, we should be able to observe and exploit the statistical differences (if any) across ``parties'' with different endowments. Participants acting the ``party'' role accumulated or lost wealth depending on whether they are elected or not elected. Every time they bought votes at some amount, that amount was discounted from their wealth. For simplicity, voters received zero endowments.\footnote{This is consistent with the vote-buying literature in that both poor and rich voters are prone to receive clientelist offerings \parencite{Bahamonde2018}. See also \textcite{Szwarcberg2013}.} In turn, participants acting the ``voter'' role accumulated or lost wealth depending on whether their party was elected or not elected (as per traditional spatial voting theories) and on whether they decided to sell or not sell their vote. It is important to note that following our formal model and \textcite[371]{Tyszler2016}, both ideology and party endowments were common knowledge among participants. 



% vote share
In addition, both parties received at random an initial vote share, that is, a \emph{certain} number of (fictional) voters that were going to cast their votes for each party. Overall, this experimental condition mimics the degree to which an election is contested. In particular, this variable accomplishes two goals. First, it puts parties in different electoral contestation environments. In other words, it introduces the element of risk (of losing the election) in the game. Since voters win or lose points when their parties win or lose elections, this risk is also relevant for players acting the ``voter'' role. Second, it gives (or not) voters a certain amount of electoral leverage. Since \textcite{Downs:1957vg}, traditional spatial theories of voting have considered that pivotal voters have more weight in an election, and hence, they might have incentive to sell their vote at higher prices. It is key in our experimental design that all these pieces of information are public.
...
Following our formal model, we also factor in a parameter \autoref{eq:ols} $\beta_{3}$ to test the effect of ideological and spatial distances on vote buying. Given the ongoing debate regarding parties target core or swinger voters, we do not have specific expectations regarding the sign of $\beta_{3}$. \autoref{eq:ols} also has a parameter $\beta_{4}$ to test the effect of having large budgets. Since it is still contested whether wealthier parties spend more on clientelism relative to poorer parties, we do not have clear expectations regarding the sign of $\beta_{4}$ either. Finally, $\beta_{5}$ tests whether parties engaged in more aggressive ways of vote buying by spending more resources on pivotal voters. Following the literature, we should expect that $\beta_{5}>0$.
...
Substantive results are shown in \autoref{m1plot} (regression table is shown in \autoref{reg:t}). Overall, results clearly depart from the theoretical expectations of traditional vote-buying theories and widely support prospect theory. Parties do not buy votes when they are losing the election but do when they are winning the election (panel 1 in \autoref{m1plot}). As prospect theory predicts, decision-makers in the domain of gains will exaggerate the unlikely scenario of losing the election and will become more risk-averse, making the strategy of vote-buying more attractive. Second, unlike traditional expectations, parties will consider sunk costs in their calculations and will buy votes when experiencing prior losses (panel 2 in \autoref{m1plot}). That is, when parties are in the domain of losses (parties that have spent or lost a considerable amount of resources in the past), they will be more risk-seeking and gamble more money on vote buying.

In panel 3 of \autoref{m1plot} we find strong support for the core vote hypothesis: political parties buy votes more frequently from voters that are ideologically closer to them. However, we also find that political parties buy these votes at relatively \emph{higher prices} (counter to traditional core voter expectations). In panel 4, results show that parties with larger budgets buy votes at higher prices, while in panel 5 we find no support for the pivotal voter argument. 
