...
\caption{{\bf Distribution of Dependent Variable.\label{dep:var:plot:fig}}\\\hspace{\textwidth} {\bf Note}: Since the focus of this paper is on vote buying, we discarded the voter data.}\centering
\end{figure}
