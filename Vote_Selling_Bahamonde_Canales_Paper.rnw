...
% central idea in prospect theory (likelihood dependence)
 In sum, prospect theory pays considerable attention to losses. The idea that ``losses loom larger than gains'' has been developed in other areas of political science \parencite[298]{McDermott2004}. For instance, \textcite[132]{Lau1985} explains that ``negative information is more influential than comparable positive information.''
...
Prospect theory ``is a theory of decision making under conditions of risk'' \parencite[15]{McDermott1998}.
...
Others have provided excellent reviews of prospect theory 
