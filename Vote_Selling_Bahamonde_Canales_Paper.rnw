...
``Risk is a central feature of political decision making'' \parencite[334]{Vis2011}. For instance, governments risk political support when pursuing unpopular reforms \parencite{Vis2007,Vis2009,Weyland2002}. Often times political parties facing electoral losses resort to alternative methods other than delivering policy packages \parencite{Kitschelt2000}. One of these alternatives is vote buying, which is defined as the distribution of rewards during elections in contingent exchange for vote choices \parencite[316]{Nichter2014}.

% Vote buying is a risky strategy, why
Vote buying is a very risky strategy. First, it is illegal. \textcite[]{Bahamonde2020a} explains that in the United States vote buying was illegal as early as the 1700s. And such, buying votes requires extra care so to avoid reputational costs and legal issues. For instance, political parties engaging in vote buying might risk losing electoral support from the wealthy \parencite{Weitz-shapiro} or from society in general \parencite{GonzalezOcantos2014}. Second, since vote choices are secret \parencite{Nichter2008} even in developing contexts such as Africa \parencite{Vicente2014} and Latin America \parencite{Hidalgo2012,Oliveros2019,Murillo2021a}, voters may accept the private benefit but later defect and vote for another party \parencite{Stokes2005,Nichter2008,GonzalezOcantos2014,Vicente2014}. 

Since clientelist political parties operate within uncertain scenarios, the literature has described a few decision-making strategies parties employ, particularly under contexts of risk. Unfortunately, all of them provide very poor-quality information at best. \textcite[1147]{Dixit1996} explain that parties track ``constituents' likes and dislikes, \emph{compulsively} participating in a spectrum of events [such as] baptisms and bar mitzvahs.''\footnote{Emphases are mine.} \textcite[317]{Stokes2005} argues that parties develop skills that allow them to infer whether clients voted for their party by \emph{looking at them in the eyes}. \textcite{Gay:1993aa,Gay1998} document similar findings for the Brazilian case. Overall, vote buying requires parties to sustain close relationships over time with their clients in a personal and individualized way \parencite{Auyero2000,Szwarcberg2013,Bahamonde2018}. Unfortunately, parties are left with no more than guesses about whether their clientelistic investments are effective or not. 


% Yet, despite these risks, vote buying is very common.
Yet, despite all these risks, political parties still buy votes in many parts of the world \parencite[F356]{Vicente2014}. In fact, in some instances vote buying is deeply embedded in the way politics is done. For instance, \textcite{Gonzalez-Ocantos2012} report that 24\% of registered voters in Nicaragua were offered a clientelist gift. 

% Why do parties keep buying votes?: Rat Choice
If clientelism is risky \parencite[43]{Szwarcberg2013}, expensive \parencite[35]{Zarazaga2014} and uncertain \parencite{Rueda2016}, \emph{Why do parties keep buying votes?} While there are multiple answers to this question, unfortunately, most quantitative researchers have framed their answers within the game-theoretical oriented expected utility theory (EUT) \parencite{Neumann:1947tc}.\footnote{For the purposes of this paper, I focus exclusively on quantitative research. Among others, very important qualitative papers are \textcite{Scott1972}, \textcite{Auyero2000} and \textcite{Szwarcberg2013}.} For instance, Do political parties target because they want to reassure loyalties (core voters) or because they want to flip voters (swing voters)? This is an important question as it speaks about the way in which parties make decisions in risky contexts. In fact, \textcite[14]{Carlin2015} states that ``our knowledge of who parties target remains incomplete.'' On the one hand, \textcite{Cox1986} and \textcite[7]{Zarazaga2015a} explain that since constituencies are well known for clientelist parties, they allocate resources to core voters. On the other hand, \textcite{Stokes2005} argues that since allocating resources to individuals who \emph{ex-ante} vote for the party is a waste, parties target swing voters. In turn, \textcite[1083]{Albertus2012a} explains that clientelist parties ``may simultaneously target both swing and core groups of voters.''
