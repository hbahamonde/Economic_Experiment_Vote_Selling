...
We contest this traditional approach focused on gains by shifting the attention to losses and context-dependent decision-making processes. It actually seems rather interesting that most vote-buying theories are framed within the EUT without even declaring it, as it if were the default or go-to framework. It needs to be clarified that the root of the problem is \emph{not} methodological (i.e., the use of game theory), but analytical, that is, the assumed decision-making process under risk present in the EUT. For instance, electoral explanations based on the EUT contend that voters see elections as ``investments'' \parencite{Downs:1957vg,Bassi2011}, a notion that also holds for clientelist political parties under risk \parencite{Diaz-Cayeros2008}. In this paper we challenge this approach by offering an alternative theory of the political economy of vote buying, but taking prospect theory as a starting point \parencite{Kahneman1979}.
...
In sum, the way in which the literature assesses clientelist targeting and political contestation seems to suggest that clientelist political parties waste valuable resources, dramatically departing from the predictions made by the EUT. We interpret this ``misbehavior'' \parencite{Thaler:2015vy} as an analytical problem, particularly, a wrong understanding of how political parties make decisions under risk. To solve this misunderstanding, next section introduces PT \parencite{Kahneman1979} to the study of vote buying. Importantly, this section sheds light on why parties do buy votes under contexts of low risk, that is when the most likely scenario is an electoral victory (as found in \cite{Gonzalez-Ocantos2012}), and also why they buy votes from both swing and core voters (as found in \cite{Albertus2012a} and \cite{Diaz-Cayeros2008}). 
...
% ``losses are harder for individuals to accept and assimilate than gains [hence, when] things are bad or likely to get worse, [people] are more likely to make risky choices to recover their losses.'' McDermott2004, 294
...
% decision-making process
    ...
    % ``Underweighting of moderate and high probabilities relative to sure things contributes to risk aversion in gains by reducing the attractiveness of positive gambles. The same effect also contributes to risk seeking in losses by attenuating the aversiveness of negative gambles. Low probabilities, however, are overweighted, and very low probabilities are either overweighted quite grossly or neglected altogether.'' Kahneman:2012tc
