...
The implications for vote buying are considerable. In sharp contrast to traditional vote-buying theories, prospect theory predicts that clientelist parties will likely buy votes when they are winning the election, that is, when they are in the domain of gains. In these scenarios, parties will find unbearable the idea of potentially losing the supporter base they already have, particularly because decision-makers are more concerned with \emph{preventing} a decline than increasing gains \parencite[89]{Levy1997}. Analytically, under such circumstances of ``loss aversion'' \parencite{Kahneman1984a,Kahneman1991a,Levy1992a,McDermott2004,Mercer2005}---i.e., parties giving more weight to potential losses---the value function will encourage risk-averse behaviors, making investments in vote buying more attractive. Our argument is consistent with \parencite[297, 299-300]{Levy1992} who explains that in the domain of gains, risk-averse decision-makers are excessively eager to secure gains, and with \textcite[1042]{Schumacher2015a}, who find that ``loss aversion motivates [agents] to become risk acceptant.''
...
% Hence, we expect vote buying to be higher in contexts where parties are winning the election.

% summary
In addition, our argument goes in line with other empirical studies that also confirm that ``actors perceive themselves to be in the domain of losses more often than we would normally expect,'' even if they are not (\cite[291]{Levy1992}; see also \cite{Lau1985}). Thus, the effects of loss aversion and the endowment effect on decision-makers will lead winning parties to perceive themselves in the domain of losses more often (even if they are not), making them more prone to gamble more resources on vote buying. Hence, the idea of potentially losing something (voters) will shift the decision-maker's (party) reference point, driving them to take the risky alternative (vote buying). Decision-makers in those situations will generally find intolerable the idea of losing acquired assets---this also applies even to ``trivial [ones, such] as candy bars or coffee mugs'' \parencite[175]{Levy1992a}.
...
% formal model
Formal models can help experimentalists to determine which theoretical settings and equilibria are most relevant to a particular causal hypothesis (\cite{McDermott2002}, \cite{Aldrich2011} and \cite[174]{Barberis2013}). Thus, in \autoref{formal:model} we developed a vote-buying game within the Downsian paradigm \parencite{Downs:1957vg,Enelow:1990aa}. The idea was to test the descriptive accuracy of the game-theory model in an experimental context (\cite[559]{Bassi2011}, \cite{Dickson2011}, \cite{Aldrich2012}, \cite[361]{Tyszler2016}, \cite[1]{Vieider2019}). This feature is particularly relevant for our identification strategy because most spatial theories of voting are based on assumptions based on the concept of expected utility maximization. This section tests for those assumptions. Epistemologically, having designed an experiment based on the precepts of economic theories of vote buying becomes a ``crucial case.'' Thus, the ``least-likely'' design approach presented in this paper should improve the inferential leverage of our results \parencite[12]{Levy2008}.% As \parencite[12]{Levy2008} explains, ``[i]nferential leverage from a least likely case is enhanced if our theoretical priors for the leading alternative explanation make it a most likely case for that theory.''
