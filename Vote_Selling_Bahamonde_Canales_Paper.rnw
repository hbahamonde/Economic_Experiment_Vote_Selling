...
The substantive idea was to reflect the fact that some parties are wealthier than others, a factor that might increase the probability of vote buying  \parencite{Juan-Pablo-Luna:2014wp}. Importantly, it is not clear whether having more resources leads to more clientelism. On the one hand, \textcite{Szwarcberg2013} explains that having economic and material resources available does not necessarily cause more vote buying. Similarly, \textcite[147]{Hagene2015} finds that political clientelism is ``perfectly possible without controlling public funds.'' On the other hand, \textcite{Bahamonde2018} explains that parties with larger budgets will engage in more expensive forms of clientelism, even buying votes from the wealthy. All things considered, the experimental designed tried to emulate an electoral market of vote buying, where parties not only faced different levels of electoral risk---see below---but also, had different economic means to deal with this problem. Since the role of party resources on clientelism is important but debated, special attention was payed to this issue by considering these dynamics in the experiment as an alternative explanation for vote buying.
...
\todo{add limitation single-issue ideol distance}
