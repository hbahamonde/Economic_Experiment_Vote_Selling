...
Reference dependence is the central idea in prospect theory (\cite[40]{McDermott1998}, \cite[178]{Barberis2013}). This aspect of the theory allows people's preferences to depend on the circumstances they face (\cite[1412]{March1987}, \cite[293-294]{McDermott2004}, \cite[168]{Fatas2007}), which is usually \parencite[335]{Vis2011}, but not always \parencite[174]{Levy1992a}, the \emph{status quo},\footnote{The location of the reference point emerges as a critical factor in the analysis of decisions \parencite[288]{Kahneman1979}. \textcite[174]{Levy1992a} explains that the reference point could also be an ``aspiration level.'' In a similar way, \textcite[1135]{Koszegi2006} developed the idea of a reference point that consists of  ``expectations rather than the status quo.'' We owe this last point to Salomo Hirvonen.} and how it shifts over time (\cite[28]{McDermott1998}, \cite[301]{McDermott2004}).\footnote{While we do not focus on the role of emotions, others have found that ``sad people will take more risk when trying to avoid a certain loss'' \parencite[6]{Campos-Vazquez2014}.} As \textcite[273]{Kahneman1979} put it more clearly, ``the carriers of value or utility are changes of wealth, rather than final asset positions.'' An important consequence is that, contrary to the assumption of invariance \parencite[186]{Barberis2013}, a shift in the reference point should also lead to reversals of preferences (\cite[719]{Quattrone1988}, \cite[643]{Thaler1990}, \cite[218]{Levy2003a}). %For instance, there is strong support for the idea that prior losses or ``sunk costs'' influence decisions, contrary to what normative theorists propose (\cite[643]{Thaler1990}, \cite[218]{Levy2003a}). 
