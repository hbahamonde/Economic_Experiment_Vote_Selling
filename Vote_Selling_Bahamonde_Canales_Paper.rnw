...
Incumbents are usually portrayed as if they were always in the domain of gains, as the ``incumbency \emph{advantage}'' concept implies. However, we tend to disagree with this view. First, the material, coordination, and political costs of maintaining a large-scale vote-buying operation is very high \parencite{Scott1969,Auyero2000,Szwarcberg2013}. Party machines need to have the capacity to grant public jobs to their clients \parencite{Calvo2004}, but also to organize rallies \parencite{Szwarcberg2012}, deliver benefits \parencite{Brusco2004}, ``\emph{acarrear}'' \parencite[577]{Hilgers2011} and monitor clients at the best of the machine's abilities \parencite[317]{Stokes2005}. Second, incumbents face a number of uncertainties. Party machines cannot effectively monitor their clients \parencite{Hicken2011} and struggle obtaining resources to be delivered in a clientelist manner \parencite{Auyero2000,Zarazaga2014}. If vote buying is expensive and uncertain, What motivates clientelist political parties to buy such massive numbers of votes, as the Nicaraguan example above suggested? In this context of uncertainty and risk, we argue that clientelist political parties will ``gamble'' more money and resources to compensate for prior losses. For every additional unit incumbents spend on vote buying, they will feel the need to spend even more to ``break even'' to try to compensate for prior losses or clientelist investments.

\todo{fix R2: it's the only thing that matters. add para. consider Boas2011}
