...
%% my design
    ...
    % Our experimental design minimizes hypothetical bias and cheap talk (Harrison2006) by compensating subjects with real money according to their decisions.
...
Formal models can usually help experimentalists determine which theoretical settings and equilibria are most relevant to a particular causal hypothesis (\textcite{McDermott2002}, \textcite{Aldrich2011} and \textcite[174]{Barberis2013}). Thus, in this section we developed a vote-buying game within the Downsian-``spatial'' paradigms \parencite{Downs:1957vg,Enelow:1990aa,Plott:1991wk}. The idea is to test the descriptive accuracy of the game-theory model in the experimental section of this paper (\cite[559]{Bassi2011}, \cite{Dickson2011}, \cite[361]{Tyszler2016}, \cite[1]{Vieider2019}).
...
Building on the game theory model, a lab economic experiment was designed. The experiment was conducted at O'Higgins University and Centre for Experimental Social Sciences (CESS) of \emph{Universidad de Santiago}, Chile. Subjects received a minimum of \$5,000 Chilean pesos. The maximum depended on the quality of individual decisions. {\color{red}summary statistics here}. The basic flow is depicted in \autoref{experimental:design:fig}. 
