...
Theories of vote buying based on the EUT have not performed particularly better either. To be clear, much progress has been made in the understanding of clientelism and vote buying in general \parencite{Hicken2011}. Yet, there are several inconsistencies that authors tend to ignore, treat them as small empirical departures, or just inconsistencies. 

For instance, \textcite[570]{Weitz-shapiro} explains that ``there is no consensus about the relationship between high levels of political competition and the phenomenon of clientelism.'' In fact, \textcite[205-206]{Gonzalez-Ocantos2012} report that in the 2008 Nicaraguan elections, the incumbent party enjoyed 40\% of the electoral support, and yet, 24\% of registered voters were offered a clientelist gift in an election that ``[was] not heavily contested.'' Why would a party buy such a large amount of votes in a safe non-contested election? 
