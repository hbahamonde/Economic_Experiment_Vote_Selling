...
% role
Building on our formal model of vote buying, we designed a lab economic experiment. At the beginning of every game, participants received a role at random. Following \textcite{Dickson2011}, roles were presented using neutral terminology to maximize experimental control. The design incorporated the following roles: \emph{party A}, \emph{party B}, or \emph{voter}. Every game was played among three players (one \emph{party A}, one \emph{party B}, and one \emph{voter}).
