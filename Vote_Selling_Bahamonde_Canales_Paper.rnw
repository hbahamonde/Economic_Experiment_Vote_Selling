...
It should be noted that the aversion is respect to potential negative electoral outcomes (i.e., losing an already acquired supporter base). This is consistent with prospect theory, particularly, with the concept of ``endowment effect:'' the very process of acquiring something (e.g. a supporter base) enhances the value of the object \parencite{Thaler1980a,Kahneman1990a}. In these situations, decision-makers (parties) tend to over-value current possessions \parencite[175]{Levy1992a}, making the risky strategy (vote buying) seem more attractive. In fact, \textcite{Horowitz2002} find that losing something looms 2.5 times more than obtaining it, thus making agents more eager to hold on to the good. Importantly, our argument is also consistent with \textcite[1042]{Schumacher2015}, where they also find that ``loss aversion motivates [agents] to become risk acceptant.'' In the context of vote buying, we argue that the idea of losing something (voters) shifts the decision-maker's reference point (party), driving them to take the risky alternative (vote buying). 

Hence, we expect vote buying to be higher in contexts where parties are winning the election. Decision makers in those situations will find intolerable the idea of losing acquired assets---even ``trivial [ones, such] as candy bars or coffee mugs'' \parencite[175]{Levy1992a}. Note that this goes in line with other empirical studies that also confirm that ``actors perceive themselves to be in the domain of losses more often than we would normally expect,'' even if they are not (\cite[291]{Levy1992}; see also \cite{Lau1985}). Thus, both loss aversion and the endowment effect will imply that winning parties will perceive themselves as in a domain of losses, making them more prone to gamble more on vote buying.
...
% role
At the beginning of every game, participants received a role at random. Following \textcite{Dickson2011}, roles were presented using neutral terminology to maximize experimental control. The design incorporated the following roles: \emph{party A}, \emph{party B}, or \emph{voter}. Every game was played among three players (one \emph{party A}, one \emph{party B}, and one \emph{voter}).
