...
Since the expected utility theory (EUT) ``was one of the first theories of decision making under risk'' \parencite[15]{McDermott1998}, EUT has dominated political science for the most part \parencite[289]{McDermott2004}, and the vote buying literature has been no exception. Just to name a few examples, \textcite{Nichter2008} used game-theoretical techniques to introduce the concept of ``turnout buying,'' suggesting that parties deliver private benefits even when monitoring is absent. \textcite{Gans-Morse2013} offer a formal model to explain that clientelist parties  offer a mix four clientelist strategies during elections (vote buying, turnout buying, abstention buying, and double persuasion), while \textcite[428]{Rueda2014a} ``present[s] a model of vote buying in which a broker sustains bribed voters' compliance by conditioning future bribes.'' Similarly, \textcite[401]{Gallego2014} ``presents a game-theoretical model of political clientelism in which a candidate disciplines a majority of voters through the promise of a future flow of benefit.'' 
...
The traditional clientelism literature offers answers that seem at odd with normative theorists in the risk-management and insurance-buying literature in economics. If we think of vote buying as an insurance against political losses, then strategic clientelist parties should ``buy'' insurance only in cases when there is a high probability that the expected electoral outcome is a loss. As \textcite[111]{Arrow1996} explains, ``those most at risk will buy more insurance than the others,'' a behavior that he describes as ``adverse selection.'' This is in line with others that find that young individuals do not buy long-term care insurance \parencite{Meier1999}. In other words, if traditional theories of vote buying conform with the EUT, clientelist political parties should prefer the certain outcome (winning the election) rather than the gamble (buying votes). As \textcite[1405]{March1987} put it, rational agents in the EUT framework, ``when faced with one alternative having a given outcome with certainty, and a second alternative which is a gamble but has the same expected value as the first, [agents] will choose the certain outcome rather than the gamble.''%\footnote{Note that the gamble has the \emph{same} expected value (mean) but differs with the certain outcome in its risk (variance).} 
