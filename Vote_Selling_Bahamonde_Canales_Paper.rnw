...
If vote buying is risky \parencite[43]{Szwarcberg2013}, expensive \parencite[35]{Zarazaga2014}, and uncertain \parencite{Rueda2016}, how do clientelist political parties allocate scarce resources efficiently? In this paper, we address two related but more specific questions about strategic vote buying related to the role of political contestation and sunk costs. First, \emph{How risk-tolerant are parties when facing contested elections?} Second, \emph{Do clientelist political parties consider ``yesterday's'' spending levels when buying votes ``today''?}  These are important questions, as they directly speak about a party's decision-making process when faced with risk. Unfortunately, we find that part of the literature provides conflicting or inconclusive answers to some of these questions. This paper posits that these gaps in some parts of the literature originate in a misunderstanding about a party's decision-making processes under risk.
