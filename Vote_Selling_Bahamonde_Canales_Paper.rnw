...
We contest this traditional approach focused on absolute gains by shifting the attention to losses and context-dependent decision-making processes. In particular, we find it limiting that most research on clientelism focuses on absolute levels of wealth, while assuming that whether decision-makers are in a domain of gains or losses should not affect their attitudes toward risk. In simple, our paper proposes that clientelist parties process their electoral and economic gains and loses not in a vacuum, but considering how prior gains and losses affect their choices \parencite[643]{Thaler1990}. Thus, we suggest to consider prospect theory as an alternative framework to study vote buying, specifically, by incorporating a decision-maker's risk propensity as it shifts in response to changes in the environment \parencite[292]{McDermott2004}. 
