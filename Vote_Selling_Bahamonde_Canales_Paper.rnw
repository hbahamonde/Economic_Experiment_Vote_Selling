...
Vote buying is a very risky strategy.\footnote{Vote buying is defined as the distribution of rewards during elections in contingent exchange for vote choices \parencite[316]{Nichter2014}.} First, it is illegal.\footnote{\textcite{Bahamonde2020a} explains that in the United States vote buying was illegal as early as the 1700s.} Buying votes requires extra care to avoid both reputational costs and legal issues. For instance, due to stigma associated with vote buying, clientelist political parties might risk electoral support from the wealthy \parencite{Weitz-shapiro} or from society in general \parencite{GonzalezOcantos2014}. Second, vote choices are secret, thus preventing parties from effective monitoring and enforcing \parencite{Nichter2008}. Even in developing contexts such as Africa \parencite{Wantchekon2003,Vicente2014} and Latin America \parencite{Hidalgo2012,Oliveros2019,Murillo2021a}, voters might accept the private benefit but then secretly vote for another party \parencite{Stokes2005,Nichter2008,Szwarcberg2013,GonzalezOcantos2014,Vicente2014}. In fact, since clientelism may also work even with low levels of enforcement and monitoring \parencite{Hicken2020}, investments in clientelism are always done in contexts of very high risk.
...
We contest this approach focused on ``gains'' by shifting the attention to losses and context-dependent decision-making processes. It actually seems interesting that most vote-buying theories are framed within the EUT as it if were the default or go-to framework to build theories upon. Thus, the root of the problem is \emph{not} methodological (i.e., the use of game-theory), but analytical, that is, the assumed decision-making process under risk present in the expected utility theory. For instance, electoral theories based on the EUT contend that voters see elections as ``investments'' \parencite{Downs:1957vg,Bassi2011}, a notion that also holds for clientelist political parties under contexts of risk \parencite{Diaz-Cayeros2008}. 
...
Theories of vote buying based on the EUT have not performed particularly better either. There are several examples that point out to a situation where vote buying rather seems a waste, or at least, where clientelist parties seem to ``misbehave.'' For instance, \textcite[205-206]{Gonzalez-Ocantos2012} report that in the 2008 Nicaraguan elections, the incumbent party enjoyed 40\% of the electoral support, and yet, 24\% of registered voters were offered a clientelist gift in an election that ``[was] not heavily contested.'' Why would a party buy such a large amount of votes in a non-contested election, particularly, in a context with such low degrees of electoral risks? 
