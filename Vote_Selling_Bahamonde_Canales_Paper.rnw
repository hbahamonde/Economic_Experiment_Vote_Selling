...
The implications for vote buying are considerable. In sharp contrast to traditional vote-buying theories, prospect theory predicts that clientelist parties will likely buy votes when they are winning the election or have experienced important losses in the past.
...
% endowmenteffect(Kahneman, Knetsch, and Thaler 1990; Thaler 1980). Individuals en- dowed with a certain good demand more (monetary) compensation to give up the good than they are willing to pay to acquire the same good. Based on a review of over 40 studies, Horowitz and McConnell (2002) find that the negative effect of losing something is about two-and-a- half times higher than the positive effect of obtaining it. Loss aversion explains this endowment effect; in posses- sion ofthe good, foregoing it is registered as a loss. Because the individual wants to hold on to the good, loss aversion motivates her to become risk acceptant (Kahneman and Tversky 1979; Tversky and Kahneman 1981). In Schumacher2015 p. 1042 THIS LAST SENTENCE FITS NICELY WITH OUR PAPER. INCLUDE Kahneman1990 ALSO.

% work on Thaler1980

% Do. (1) ver si los comentarios de los r's apuntan a modificar la relacion risk-aversion.

% 1 why Clientelist parties should buy votes when they are probable winners
Clientelist parties will likely buy more votes when they are winning the election, that is, when they are in the domain of gains. In these scenarios parties will find unbearable the idea of potentially losing the political base they already have. In terms of the argument, we posit that loss aversion explains why decision-makers are more concerned with preventing a decline than increasing gains (\cite{Levy1992}, see also \cite[89]{Levy1997}). Analytically, under such circumstances, parties will give more weight to potential losses, while the value function will encourage risk-averse behaviors making investments in vote buying more attractive. It should be noted that the aversion is respect to negative prospective electoral outcomes, i.e., losing an important portion of the political base already acquired. This is consistent with prospect theory, particularly, with the concept of the ``endowment effect:'' the very process of acquiring something (e.g. an important political base) enhances the value of the object, making decision-makers to over-value current possessions (\cite{Thaler1980}, \cite[175]{Levy1992a}). Thus, agents will find intolerable the idea of losing acquired assets, even ``trivial [ones, such] as candy bars or coffee mugs'' \parencite[175]{Levy1992a}, enhancing then the false perception that agents might actually be in the domain of losses. In fact, empirical studies confirm that ``actors perceive themselves to be in the domain of losses more often than we would normally expect,'' even if they are not (\cite[291]{Levy1992}; see also \cite{Lau1985}). To sum, when things are going well electorally, clientelist political parties will tend to buy more votes because ``future losses hurt more than future gains gratify'' \parencite[285]{Levy1992}. Thus, we expect vote buying to be an attractive strategy in favorable electoral scenarios due to the absolute aversion and intolerance of losing an already acquired important political base. %The mechanics of such a decision-making process should then make clear that there is no ``wasting'' when when buying votes while in the domain of gains.
