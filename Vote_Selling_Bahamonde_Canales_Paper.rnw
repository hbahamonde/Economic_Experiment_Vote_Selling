...
Substantive results are shown in \autoref{m1plot} (regression table is shown in \autoref{reg:t}). Overall, results strongly supports prospect theory.\todo{pending} 
