...
\paragraph{Sunk Costs} In other respects, our argument conforms with past research, but for different reasons. Our explanation is different because it considers that decision-makers weigh their options respect to a reference point which in turn explains higher levels of vote-buying. Traditional vote-buying theories usually explain that incumbents enjoy important comparative advantages over challengers. Since incumbents are in office while campaigning, they are usually able to divert public resources to vote-buying \parencite{Cox1986a,Dixit1996,Dahlberg2002}. While incumbents' relatively higher levels of clientelist spending may be explained by their disposable public resources \parencite{Hicken2007}, we believe this is a necessary but insufficient condition to vote-buying.\footnote{Having more available resources has been associated with deterring likely challengers \parencite{Medina2002,Grzymala-busse2008}.}

The cost of maintaining a large-scale vote-buying operation is very high \parencite{Scott1969,Auyero2000,Szwarcberg2013}. Party machines need to have the capacity to grant public jobs to their clients \parencite{Calvo2004}, but also to organize rallies \parencite{Szwarcberg2012}, deliver goodies \parencite{Brusco2004}, and ``acarrear'' \parencite[577]{Hilgers2011} and monitor clients at the best of the machine's abilities \parencite[317]{Stokes2005}. However, having the \emph{capacity} to buy votes is a necessary but insufficient condition to explain the \emph{use} of clientelism \parencite[33]{Szwarcberg2013}. Thus, while incumbents might have more available resources, they do not necessarily will buy more votes. 

Building on \textcite{Szwarcberg2013}, we consider an additional scope condition under which clientelist political parties spend more on vote-buying. In particular we argue that incumbents not only need to have the capacity to deliver (as the traditional literature on vote-buying explains) but also have a history of large prior investments: the larger prior spending levels were, the larger the spending will be. The argument does not rely on some deterministic treat of the incumbent but about the need to compensate for prior losses. 



Incumbents are always portrayed as if they always were in the domain of gains, as the ``incumbency advantage'' concept implies. However, incumbents face a number of uncertainties. Party machines cannot really monitor their clients \parencite{Hicken2011} and struggle obtaining resources to be delivered in a clientelist manner \parencite{Auyero2000,Zarazaga2014}. Thus, knowing whether their time and resources spent on clientelism were an ``investment'' or a ``waste'' is really hard for them. However, what is certain is that they have spent certain amount. In this context of uncertainty and risk, we argue that clientelist political parties will gamble more resources to compensate for prior losses or to ``break even.''
...
% summary
In sum, the way in which the literature assesses clientelist targeting and political contestation seems to suggest that clientelist political parties waste valuable resources, dramatically departing from the predictions made by the EUT. We interpret this ``misbehavior'' \parencite{Thaler:2015vy} as an analytical problem, particularly, a wrong understanding of how political parties make decisions under risk. To solve this misunderstanding, next section introduces prospect theory \parencite{Kahneman1979} to the study of vote buying. Importantly, this section sheds light on why parties do not necessarily consider whether clients are swing/core voters, and also why they buy votes in contexts of low risk, that is when the most likely scenario is an electoral victory. 
