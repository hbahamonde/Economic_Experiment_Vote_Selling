...
Authors are listed in alphabetical order. We thank Jack Levy for his detailed comments and helpful revisions. We also thank Barbara Vis, Janne Tukiainen, Lauri Saaksvuori and Salomo Hirvonen for their insightful comments and suggestions. We thank O'Higgins University for funding part of this project, as well as the participants of the colloquium at the Centre for Experimental Social Sciences at Universidad de Santiago (Santiago, Chile), the ``DPINVEST \& INVESThub Workshop on Interventions, Evaluations and Field Experiments,'' the Political Science and Economics Seminars at Turku University, the General Seminar at \AA bo Akademi (all of them held in Turku, Finland), the ECPR 2022 General Conference (Innsbruck, Austria), the EPSA 2022 Annual Conference (Prague, Czech Republic), the 2022 Conference of the Society for Institutional \& Organizational Economics (Toronto, Canada) and the 2022 Latin American Studies Association Congress (virtual). We would also like to thank the Editor of Electoral Studies, and the three reviewers for their suggestions and constructive criticism. Their comments certainly improved the paper significantly. Javiera Tobar, Cristopher Reyes and Basti\'an Garrido provided excellent research assistance. The usual caveats apply.}}
...
Formal models can usually help experimentalists to determine which theoretical settings and equilibria are most relevant to a particular causal hypothesis (\cite{McDermott2002}, \cite{Aldrich2011} and \cite[174]{Barberis2013}). Thus, we developed a vote-buying game within the Downsian ``spatial'' paradigms \parencite{Downs:1957vg,Enelow:1990aa} to test the descriptive accuracy of the game-theory model in the experimental section of this paper (\cite{Lupia:1998ub}, \cite[559]{Bassi2011}, \cite{Dickson2011}, \cite[361]{Tyszler2016}, \cite[1]{Vieider2019}).
