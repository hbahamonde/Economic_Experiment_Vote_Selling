...
1. ``Risk is a central feature of political decision making '' \parencite[334]{Vis2011}. For instance, governments might need to pursue unpopular reforms \parencite{Vis2007,Vis2009,Weyland2002}, probably upsetting loyal constituents. Often times, while campaigning political parties might fear losing elections, and as a consequence, might feel the need to resort to alternative methods different than delivering policy packages \parencite{Kitschelt2000} in order to secure electoral victories. Vote buying is an electoral technique which \todo{define}. Why do Parties Buy Votes? For several reasons vote buying is a risky strategy. First, it is illegal (see \textcite{Bahamonde2020a} for a historical review on the United States). Political parties engaging in vote buying, for instance, might risk electoral costs such as losing electoral support of the wealthier \parencite{Weitz-shapiro}. Second, vote choices are secret, and thus, voters may accept the particularistic benefit from the clientelist party but then defect and vote for another party \parencite{Stokes2005,Nichter2008}. Yet, despite these risks political parties still engage in vote buying. 
...
% ``rational choice and game theoretic models have become ascendant in political science and have achieved some dominance within it'' McDermott2004, 289
...
% ``Expected value was one of the first theories of decision making under risk.''  McDermott1998, 15

% ``The expected value of an outcome is equal to its payoff times its probability.''  McDermott1998, 15
