...
% basics of EUT
As its core, the expected utility theory considers that the value of an outcome is equal to its payoff times its probability, and that agents choose the option with the highest weighted sum  (\cite[15]{McDermott1998}, \cite[173]{Levy1992a}, \cite[88]{Levy1997}). Importantly, it is commonly assumed that all political agents obey the maxims of invariance, dominance, and transitivity leading to the maximization of utility (\cite[291]{McDermott2004}, \cite[719]{Quattrone1988}).


% Formal models in clientelism
Since the expected utility theory (EUT) was one of the first theories of decision making under risk\parencite[15]{McDermott1998}, EUT has dominated political science for the most part (\cite[289]{McDermott2004}, \cite[87]{Levy1997}), and the vote buying literature has been no exception. Just to name a few examples, \textcite{Nichter2008} used game-theoretical techniques to introduce the concept of ``turnout buying,'' suggesting that parties deliver private benefits even when monitoring is absent. \textcite{Gans-Morse2013} offer a formal model to explain that clientelist parties offer a mix of four clientelist strategies during elections (vote buying, turnout buying, abstention buying, and double persuasion), while \textcite[428]{Rueda2014a} ``present[s] a model of vote buying in which a broker sustains bribed voters' compliance by conditioning future bribes.'' Similarly, \textcite[401]{Gallego2014} ``presents a game-theoretical model of political clientelism in which a candidate disciplines a majority of voters through the promise of a future flow of benefit.'' 
